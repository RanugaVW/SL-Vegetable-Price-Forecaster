...
file_path = os.path.join(base_dir, "Initial Dataset Summary", "missing_cells_complete_summary.csv")
...
output_path = os.path.join(base_dir, "Initial Dataset Summary", "removal_analysis.txt")
